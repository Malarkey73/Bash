...
#alternative to uniq ->  awk '!array[$2,$3, $6]++' no consecutive start, end, strand
...
paste "$ChIP.bedgraph" "$Input.bedgraph" | awk '{if ($8 != "." && $4 > $8) {print $1,$2,$3,$4-$8}else{print $1,$2,$3,0}}' | sed -e 's/ /\t/g' > "$ChIP$Input.bedgraph" &&
