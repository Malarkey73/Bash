...
# data shortcuts
FQFOLDER="/mnt/store1/rawdata/FASTQ/Cortex"
BAMFOLDER="/mnt/store1/rawdata/FASTQ/Cortex/BAM"
# reference shortcuts
...
export FQFOLDER; export BAMFOLDER; export GENOME; export BOWTIE2; export SAMTOOLS

# This is a basic script to (not trim), align, convert bam to sam and then sort paired reads. To adapt it to you should:
...
do
 ...
 #               mkfifo $FQFOLDER/R1.fifo
        ...
        $BOWTIE2 -p 24 -x $GENOME -U $fq | $SAMTOOLS view -bS - | $SAMTOOLS sort - $prefix"sorted"
done
